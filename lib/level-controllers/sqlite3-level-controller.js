 ...
 * @param config
 */
var Sqlite3LevelController = function(config) {
    Sqlite3LevelController.super_.apply(this, arguments);
    
    if(!config.levelControllerConfig.fileName || typeof config.levelControllerConfig.fileName !== 'string' && config.levelControllerConfig.fileName.length === 0) {
         throw Errors.invalidConfig("Sqlite3 'fileName' missing in configuration file");
    }
...
util.inherits(Sqlite3LevelController, BaseLevelController);

Sqlite3LevelController.prototype.getConnection = function(callback) {
    var tableName = this.config.levelControllerConfig.tableName;
    var connection =  new sqlite3.Database(this.config.levelControllerConfig.fileName);
 ...
 */
Sqlite3LevelController.prototype.saveCurrentLevel = function(level, callback) {
    var self = this;
    var tableName = this.config.levelControllerConfig.tableName;
 ...
 */
Sqlite3LevelController.prototype.retrieveCurrentLevel = function(callback) {
    var self = this;
    var tableName = this.config.levelControllerConfig.tableName;
